...
public class ComputeTaxesForSingleFillers {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        // Enter the filling status and taxable income
        System.out.print("Enter the filling status, 0 for single filers, 1 for married filing jointly or widow(er),\n 2 for married filing separately, 3 for head of house hold, 4 for all filling status: ");
        ...
        if (fillingStatus == 0) {
            if (taxableIncome <= 8350) {
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82550) * 0.28 + (taxableIncome - 171550) * 0.33;
            }
            else {
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82550) * 0.28 + (372950 - 171550) * 0.33 + (taxableIncome - 372950) * 0.35;
            }
            ...
            tax = (8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82550) * 0.28 + (372950 - 171550) * 0.33 + (taxableIncome - 372950) * 0.35) + (16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (372950 - 208850) * 0.33 + (taxableIncome - 372950) * 0.35) + (8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (taxableIncome - 104425) * 0.33) + (11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28 + (372950 - 190200) * 0.33 + (taxableIncome - 372950) * 0.35);
        } else {
